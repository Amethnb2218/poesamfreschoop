// SHA-256 pur JS — port fidèle du fallback utilisé côté site web
// (freshcoopfinal/src/App.jsx). Doit produire EXACTEMENT le même hash hex
// pour que les comptes du site puissent se connecter depuis l'app mobile.

export function sha256Js(message: string): string {
